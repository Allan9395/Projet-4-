...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="index.php?action=admin">Billet simple pour l'Alaska</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav my-2 mt-2 mt-lg-0">
        <li class="nav-item active">
          <a class="nav-link" href="index.php?action=admin"><i class="fas fa-home"></i> Accueil</a>
        </li>
        <li class="nav-item active">
          <a class="nav-link" href="index.php?action=createChapter"><i class="fas fa-user-edit"></i> Créer un chapitre</a>
        </li>
        <li class="nav-item active">
          <a class="nav-link" href="index.php?action=alertsComments"><i class="fas fa-user-plus"></i>Commentaires signalés</a>
        </li>
        <li class="nav-item active">
